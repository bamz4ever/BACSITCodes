...
if($_SERVER["REQUEST_METHOD"] == "POST"){
   ...
   // Validate confirm Email
    ...
    if(empty($username_err) && empty($email_err) && empty($password_err) && empty($confirm_password_err)){
		...
		// Prepare an insert statement
             $sql1 = "INSERT INTO student (student_email, users_id) VALUES ( ?, ?)";
         
            if($stmt1 = mysqli_prepare($link, $sql1)) {
                    // Bind variables to the prepared statement as parameters
                mysqli_stmt_bind_param($stmt1, "si", $param_email,  $param_users_id);
					...
					<div class="col-lg-8 col-md-8">
						...
						<form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
							...
							<div class="mt-10 <?php echo (!empty($email_err)) ? 'has-error' : ''; ?>">
								<input type="text" name="email" placeholder="yourstudent@example.com"
